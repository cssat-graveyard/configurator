namespace PortalConfigurator
{
	partial class HelpItemDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.contentWebBrowser.DocumentCompleted += new System.Windows.Forms.WebBrowserDocumentCompletedEventHandler(this.contentWebBrowser_DocumentCompleted);
			// 
			// toolStrip
			// 
			...
			this.toolStrip.Items.Add(this.cutToolStripButton);
			...
			this.toolStrip.Items.Add(this.copyToolStripButton);
			...
			this.toolStrip.Items.Add(this.pasteToolStripButton);
			...
			this.toolStrip.Items.Add(this.boldToolStripButton);
			...
			this.toolStrip.Items.Add(this.underlineToolStripButton);
			...
			this.toolStrip.Items.Add(this.italicsToolStripButton);
			...
			this.toolStrip.Items.Add(this.createLinkToolStripButton);
